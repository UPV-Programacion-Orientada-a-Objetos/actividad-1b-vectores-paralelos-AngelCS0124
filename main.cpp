...
tam (los productos proedefinidos, con el proposito de no recorrer los otros 95 indices vaciaas de los arrays)
...
int mostrarMenu(){
    ...
    while (!inputValido || opcion < 1 || opcion > 5){
        std::cout << "--- Ferreteria 'Pablito clavo un clavito' ---" << std::endl;
